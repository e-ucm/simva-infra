...
Serious Games (SGs) are digital games designed for different purposes other than entertainment. For example, SGs can be designed to provide knowledge, upgrad skills, or raise awareness. In fact, SGs were successfully implemented in different domains such as in military, business, medicine, schools, etc. Also, SGs present new opportunities to apply stealth assessment techniques for evaluating player performance, typically by analyzing  players interaction data.
