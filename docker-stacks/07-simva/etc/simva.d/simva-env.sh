...
export COMPOSE_FILE="docker-compose.yml:docker-compose.mongo.yml:docker-compose.sqlite.yml"
if [[ "${SIMVA_ENVIRONMENT}" = "development" ]]; then
    export COMPOSE_FILE="$COMPOSE_FILE:docker-compose.dev.mongo.yml:docker-compose.dev.sqlite.yml"
