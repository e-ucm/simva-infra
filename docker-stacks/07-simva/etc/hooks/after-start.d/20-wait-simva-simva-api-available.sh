...
${SIMVA_HOME}/bin/wait-available-with-connection.sh "SIMVA API" "https://${SIMVA_SIMVA_API_DATA_HOST_SUBDOMAIN}.${SIMVA_EXTERNAL_DOMAIN}/users/login" "$payload" "token" "false"