...
if [[ ! -e "${SIMVA_DATA_HOME}/limesurvey/.initializedRemoteControl-Update_plugin_settings" ]]; then 
    ...
    NEW_FUNCTION_FILE_NAME="update_plugin_settings.php"
    ...
    touch "${SIMVA_DATA_HOME}/limesurvey/.initializedRemoteControl-Update_plugin_settings"
fi