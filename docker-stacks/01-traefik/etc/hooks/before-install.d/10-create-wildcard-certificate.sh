...
echo "Starting wildcard certificate and truststore installation..."
...
"${HELPERS_STACK_HOME}/05-install-dhparams.sh"
echo "Wildcard certificate and truststore installation completed."