...
if [[ -e "${SIMVA_DATA_HOME}/keycloak/.initialized" ]]; then
    rm "${SIMVA_DATA_HOME}/keycloak/.initialized"
fi
if [[ -e "${SIMVA_DATA_HOME}/keycloak/.externaldomain" ]]; then
    rm "${SIMVA_DATA_HOME}/keycloak/.externaldomain"
fi 
if [[ -e "${SIMVA_DATA_HOME}/keycloak/.version" ]]; then
    rm "${SIMVA_DATA_HOME}/keycloak/.version"
fi