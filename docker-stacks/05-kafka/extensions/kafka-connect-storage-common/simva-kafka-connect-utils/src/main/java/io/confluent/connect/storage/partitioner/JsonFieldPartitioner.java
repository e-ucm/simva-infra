 ...
 */
 ...
 import io.confluent.connect.storage.util.JsonDataUtils;
 ...
 public class JsonFieldPartitioner<T> extends DefaultPartitioner<T> {
   ...
   private String getPartitionValue(Object structOrMap, String fieldName, Schema valueSchema) {
     Object partitionValue = JsonDataUtils.getNestedFieldValue(structOrMap, fieldName);
 
     Type type = null;
     if (valueSchema != null) {
       Schema fieldSchema = JsonDataUtils.getNestedField(valueSchema, fieldName).schema();
