...
public class CustomJsonFormat implements Format<S3SinkConnectorConfig, String> {
  private static final Logger log = LoggerFactory.getLogger(CustomJsonFormat.class);
  private final S3Storage storage;
  private final JsonConverter converter;

  public CustomJsonFormat(S3Storage storage) {
  ...
  public RecordWriterProvider<S3SinkConnectorConfig> getRecordWriterProvider() {
    return new CustomJsonRecordWriterProvider(storage, converter);
  }
