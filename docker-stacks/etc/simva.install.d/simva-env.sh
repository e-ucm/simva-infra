...
#MINIO IMAGE
export SIMVA_MINIO_IMAGE="quay.io/minio/minio"
export SIMVA_MINIO_VERSION="RELEASE.2025-02-28T09-55-16Z"
export SIMVA_MINIO_MC_IMAGE="quay.io/minio/mc"
...
#RUSTFS IMAGE
export SIMVA_RUSTFS_IMAGE="rustfs/rustfs"
export SIMVA_RUSTFS_VERSION="1.0.0"
export SIMVA_RUSTFS_RC_IMAGE="rustfs/rc"
export SIMVA_RUSTFS_RC_VERSION="v0.1.36"
#RUSTFS SETTINGS
export SIMVA_RUSTFS_ENABLE="true"
export SIMVA_RUSTFS_GUID="10001"
export SIMVA_RUSTFS_UUID="10001"
export SIMVA_RUSTFS_TOP_DIR_MODE="10001"
export SIMVA_RUSTFS_DIR_MODE="755"
export SIMVA_RUSTFS_FILE_MODE="644"
