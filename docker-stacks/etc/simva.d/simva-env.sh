...
export SIMVA_SIMVA_API_INTERNAL_PORT="3000"
export SIMVA_SIMVA_API_EXTERNAL_PORT="443"
#Short URL
...
#PUMVA
export SIMVA_PUMVA_API_HOST_SUBDOMAIN="pumva-api"
...
# PUMVA ACCESS_KEY AND SECRET_KEY FOR KEYCLOAK
