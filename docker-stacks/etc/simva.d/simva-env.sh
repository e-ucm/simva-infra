...
export SIMVA_TRACE_ALLOCATOR_MAX_DELAY="$(5*60*1000)" #5 mins in ms
export SIMVA_TRACE_ALLOCATOR_REFRESH_INTERVAL="$(4*60*60*1000)" #4 hours in ms
...
export SIMVA_TRACE_ALLOCATOR_GC_INTERVAL="$(10*24*60*60*1000)" #10 days in ms
